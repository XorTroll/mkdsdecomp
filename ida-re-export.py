...
def export_all_to_header(out_types_header_file, out_syms_header_file, out_aliases_asm_file):
    ...
    with open(out_syms_header_file, "w") as f:
        with open(out_aliases_asm_file, "w") as asm_f:
            ...
            f.write(f"/* Generated by mkdsdecomp: https://github.com/XorTroll/mkdsdecomp, at {time_fmt} */\n\n")

            asm_f.write("@ MKDS (EU) ARM9 function ARM <-> Thumb wrappers\n")
            asm_f.write(f"@ Generated by mkdsdecomp: https://github.com/XorTroll/mkdsdecomp, at {time_fmt} */\n\n")
...
symbols_x_path = os.path.join(gen_dir, "mkds-eu-decomp-symbols.x")
...
types_header_path = os.path.join(include_dir, "mkds-eu-decomp-types.h")
syms_header_path = os.path.join(include_dir, "mkds-eu-decomp.h")
aliases_asm_path = os.path.join(source_dir, "mkds-eu-decomp-thumb-wrappers.s")
