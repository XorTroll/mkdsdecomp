#ifndef _NTR_ARM9_UTIL_H
#define _NTR_ARM9_UTIL_H

#include <ntr/base.h>

#define NTR_ARM9_UTIL_ALIGN_UP(val, align) (((val) + (align - 1)) & ~(align - 1))
#define NTR_ARM9_UTIL_ALIGN_DOWN(val, align) ((val) & ~(align - 1))
