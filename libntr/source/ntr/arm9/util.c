...
#define _NTR_ARM9_UTIL_INTRUSIVE_LIST_ITEM_NODE(list, item) ((Util_IntrusiveListNode*)(item + list->item_list_node_offset))

void Util_IntrusiveList_InsertFirstItem(Util_IntrusiveList *self, void *item) {
    Util_IntrusiveListNode *item_node = _NTR_ARM9_UTIL_INTRUSIVE_LIST_ITEM_NODE(self, item);
...
void *Util_IntrusiveList_GetPrevItem(Util_IntrusiveList *self, void *item) {
    ...
    if(item != NULL) {
        return _NTR_ARM9_UTIL_INTRUSIVE_LIST_ITEM_NODE(self, item)->item_prev;
    }
    else {
...
void Util_IntrusiveList_InsertFirst(Util_IntrusiveList *self, void *item) {
    if(self->item_list_head != NULL) {
        _NTR_ARM9_UTIL_INTRUSIVE_LIST_ITEM_NODE(self, item)->item_prev = NULL;
        _NTR_ARM9_UTIL_INTRUSIVE_LIST_ITEM_NODE(self, item)->item_next = self->item_list_head;
        _NTR_ARM9_UTIL_INTRUSIVE_LIST_ITEM_NODE(self, self->item_list_head)->item_prev = item;
        self->item_list_head = item;
...
void Util_IntrusiveList_InsertLast(Util_IntrusiveList *self, void *item) {
    if(self->item_list_head != NULL) {
        _NTR_ARM9_UTIL_INTRUSIVE_LIST_ITEM_NODE(self, item)->item_prev = self->item_list_tail;
        _NTR_ARM9_UTIL_INTRUSIVE_LIST_ITEM_NODE(self, item)->item_next = NULL;
        _NTR_ARM9_UTIL_INTRUSIVE_LIST_ITEM_NODE(self, self->item_list_tail)->item_next = item;
        self->item_list_tail = item;
...
void Util_IntrusiveList_RemoveItem(Util_IntrusiveList *self, void *item) {
    ...
    if(item_node->item_prev != NULL) {
        _NTR_ARM9_UTIL_INTRUSIVE_LIST_ITEM_NODE(self, item_node->item_prev)->item_next = item_node->item_next;
    }
    else {
    ...
    if(item_node->item_next != NULL) {
        _NTR_ARM9_UTIL_INTRUSIVE_LIST_ITEM_NODE(self, item_node->item_next)->item_prev = item_node->item_prev;
    }
    else {
