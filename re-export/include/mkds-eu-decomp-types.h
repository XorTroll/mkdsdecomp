...
enum TextSystem_FadeY {
    ...
    TextSystem_FadeY_80 = 1,
    TextSystem_FadeY_255 = 2,
};
...
struct G2d_Sprite {
    ...
    /* off 0x14 size 0x4 */
    void (__fastcall *draw_tile_fn)(G2d_Sprite *, NFTR *, int, int, int, StructCG *);

    /* off 0x18 size 0x4 */
    void *fill_with_color_fn;
...
struct StructZE {
    ...
    /* off 0x1608 size 0x4 */
    StateDualHandler *some_e7_2;

    /* off 0x160C size 0x4 */
    StateDualHandler *some_e7;
