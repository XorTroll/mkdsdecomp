...
enum StructMQFlagsD {
    StructMQFlagsD_None = 0,
    StructMQFlagsD_Unk10 = 16,
    StructMQFlagsD_Unk10000 = 65536,
    StructMQFlagsD_Unk20000 = 131072,
};

enum StructMQFlagsC {
    StructMQFlagsC_None = 0,
    StructMQFlagsC_Unk1000 = 4096,
};

enum RaceFinishStatus {
    RaceFinishStatus_NotFinished = 0,
    RaceFinishStatus_FinishedCrossing = 1,
    RaceFinishStatus_Unk2 = 2,
    RaceFinishStatus_FinishedNotCrossing = 3,
...
enum DialogKind {
    DialogKind_Progress = 0,
    DialogKind_SingleButton = 1,
    DialogKind_DoubleButton = 2,
};

enum SaveDataReadResult {
    SaveDataReadResult_Failure = 0,
    SaveDataReadResult_Success = 3,
...
typedef struct StructAD00SubSub StructAD00SubSub;

typedef struct StructCharacterPhysicalParam StructCharacterPhysicalParam;
...
typedef struct StructMQSub StructMQSub;
...
typedef struct SelectReturnGraphics SelectReturnGraphics;
...
_Static_assert(sizeof(StructJT) == 0x28, "StructJT definition");
...
struct StructDL {
    /* off 0x0 size 0x4 */
    u32 dl01_maybe_cur_state;

    /* off 0x4 size 0x4 */
    u32 dl02_maybe_new_state;

    /* off 0x8 size 0x4 */
    u32 dl03_maybe_prev_state;
...
_Static_assert(sizeof(StructAD00SubSub) == 0x30, "StructAD00SubSub definition");

/* size 0x8 */
struct StructCharacterPhysicalParam {
    /* off 0x0 size 0x4 */
    u32 p1;
...
_Static_assert(sizeof(StructCharacterPhysicalParam) == 0x8, "StructCharacterPhysicalParam definition");
...
struct StructMQSub {
    ...
    /* off 0x80 size 0xC */
    IntrusiveListWrapper list_1;

    /* off 0x8C size 0xC */
    IntrusiveListWrapper subsub_list;
...
_Static_assert(sizeof(StructMQSub) == 0xB8, "StructMQSub definition");
...
_Static_assert(sizeof(SelectReturnGraphics) == 0x828, "SelectReturnGraphics definition");
...
struct LogoContext {
    ...
    /* off 0x34 size 0x4 */
    u32 erase_data_wait_frame_counter;
...
struct StructRC {
    ...
    /* off 0x30 size 0x4 */
    u32 some_flags_and_respawn_id;

    /* off 0x34 size 0x2 */
    u16 maybe_max_cpoi_idx;

    /* off 0x36 size 0x2 */
    u16 maybe_max_cpoi_idx_2;
...
struct StructMQRacerEntry {
    ...
    /* off 0x80 size 0xC */
    VecFx32 vec_player_pos;

    /* off 0x8C size 0xC */
    VecFx32 vec_a_some_pos;
    ...
    /* off 0x1D0 size 0x4 */
    u32 kart_collision_sphere_size;
...
struct StructCourseHolder {
    /* off 0x0 size 0x4 */
    StructML *course_model;

    /* off 0x4 size 0x4 */
    StructML *course_model_V;

    /* off 0x8 size 0x38 */
    StructAM course_model_anim_nsbtp;

    /* off 0x40 size 0x38 */
    StructAM course_model_anim_nsbta;

    /* off 0x78 size 0x38 */
    StructAM course_model_V_anim_nsbta;
...
struct OverlayManager {
    ...
    /* off 0xA4 size 0x4 */
    Mem_HeapHead *ovlunk_region_heap_hnd;

    /* off 0xA8 size 0x4 */
    u32 min_ovl_region_addr;

    /* off 0xAC size 0x4 */
    u32 max_ovl_region_addr;
