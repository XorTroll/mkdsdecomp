...
_Static_assert(sizeof(Vector3) == 0xC, "Vector3 definition");
...
_Static_assert(sizeof(DmaIrqEntry) == 0xC, "DmaIrqEntry definition");
...
_Static_assert(sizeof(StructNASub) == 0x10, "StructNASub definition");
...
_Static_assert(sizeof(Jnt0Block) == 0x8, "Jnt0Block definition");
...
_Static_assert(sizeof(DmaIrqHolder) == 0x30, "DmaIrqHolder definition");
...
struct StructHD {
    /* off 0x0 size 0xC */
    Vector3 vec_f_val_d_cross_e;

    /* off 0xC size 0xC */
    Vector3 vec_e_val_a_cross_d;
