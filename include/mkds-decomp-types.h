...
_Static_assert(sizeof(StructR) == 0x10, "StructR definition");
...
_Static_assert(sizeof(Dict) == 0xC, "Dict definition");
...
_Static_assert(sizeof(Mdl0Block) == 0x14, "Mdl0Block definition");
...
_Static_assert(sizeof(Mdl0ModelEntry) == 0x48, "Mdl0ModelEntry definition");
...
_Static_assert(sizeof(StructIT) == 0x38, "StructIT definition");
...
_Static_assert(sizeof(Tex0Block) == 0x48, "Tex0Block definition");
...
struct DisplayConfig {
    ...
    /* off 0x70 size 0x44 */
    DisplayEngineConfig sub_engine_cfg;
